...
from medications.views import create_medication, update_medication, delete_medication, med_info, med_indications, med_dosages, med_contraindications, med_boxed_warning, med_side_effects
...
urlpatterns = [
    ...
    path('<int:id>/med_info/contraindication/', med_contraindications, name='med_contraindications'),
    path('<int:id>/med_info/boxed_warning/', med_boxed_warning, name='med_boxed_warning'),
